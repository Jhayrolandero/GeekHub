...
<body>
    <div class="container-fluid bg-container">
        ...
        <section class="row" id="login-section">
            <div class="col-sm-12 col-md-6 title-container">
                ...
                <section class="text-center login-form-container">
                    <div class="row forms-field">
                        <form action="">
                            ...
                            <div class="col-12">
                                <button class="btn register-btn" type="submit" id="login">Sign Up</button>
        ...
        <section class="row" id="register-section">
            ...
            <div class="col-sm-12 col-md-5 register-container">
                <section class="text-center register-form-container">
                    <div class="row forms-field">
                        <form action="">
                            <div class="col-12">
                                <h1>Join Us!</h1>
                            ...
                            <div class="col-12">
                                <input type="text" class="auth-form" autocomplete="off" placeholder="Username" id="username">
                            </div>
                            <div class="col-12 mt-4">
                                <input type="email" class="auth-form" autocomplete="off" placeholder="Email" id="r-email">
                            </div>
                            <div class="col-12 mt-4">
                                <input type="password" class="auth-form" autocomplete="off" placeholder="Password" id="r-password">
                            </div>
                            <div class="col-12 mt-4">
