$(document).ready(function(){
    ...
    $.get("app/controller/FriendController.php?action=suggestion", function(data) {
    ...
    $("#friend-content").on("click", ".suggestion-card .profile-btn", function (event) {
        event.preventDefault();

        var friend_id = $(this).closest(".suggestion-card").find(".friend_id").val();

        $.get(`app/controller/UserController.php?action=getProfile&buddyID=${friend_id}`,
    ...
    $("#friend-content").on("click", ".suggestion-card .accept-btn", function () {
        ...
        var friendship_ID = $(this).closest(".suggestion-card").find(".friendship_id").val();
